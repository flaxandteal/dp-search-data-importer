...
type Handler interface {
	Handle(ctx context.Context, cfg *config.Config, publishedContentExtracted *models.PublishedContentExtracted) error
}
...
func unmarshal(message kafka.Message) (*models.PublishedContentExtracted, error) {
